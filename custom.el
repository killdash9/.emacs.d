(custom-set-variables
 ...
 '(dirtrack-list '("^\\(.*/.*\\)\\$ " 1))
 '(eclim-accepted-file-regexps '("\\.java" "\\.groovy"))
 ...
 '(flycheck-phpmd-rulesets '("cleancode" "design" "unusedcode"))
 ...
 '(magit-refs-margin '(nil age magit-log-margin-width t 18))
 ...
 '(org-refile-targets '(("~/org/life.org" :level . 2)))
 ...
 '(package-pinned-packages '((csv-mode . "\"gnu\"")))
 ...
 '(safe-functions '(ignore calc-call))

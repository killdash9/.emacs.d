...
(deftheme atari
  "Atari BASIC Color Theme.  This is an attempt to recreate the look and feel of my old Atari 800 BASIC interpreter.  It looks like this:  http://upload.wikimedia.org/wikipedia/commons/8/85/AtariBasicExample.png")

(defun atari-click ()
  "Play the Atari Basic click"
  (when (symbolp this-command)
      (unless 
          (string-match-p "^mouse-\\|^mwheel-\\|-wheel-\\|^nil$" (symbol-name this-command))
        (play-sound '(sound :file "~/.atari-click.mp3")))))

;; Write the click mp3 file to the disk
...
YghYmLCsGgUDCADAFmVzhgYAAA=="))
    (zlib-decompress-region 1 (point-max))))
...
(let
  ...
  (custom-theme-set-faces
   'atari
   '(default ((t (:inherit nil :stipple nil :background "#175A68" :foreground "#67ABB9" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :height 400 :family "Atari Classic Chunky"))))
